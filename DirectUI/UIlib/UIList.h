...
public:
    ...
    virtual void DrawItemText( GRAPHorHDC& gorh, const RECT& rcItem) = 0;
};
...
public:
    ...
    void HomeLeft();
    void EndRight();
    void EnableScrollBar(int bEnableVertical =UISCROLL_AUTO, int iStyleHorizontal=UISCROLL_NONE);
...
{
	DECLARE_DYNCREATE( CListHeaderItemUI )
public:
    CListHeaderItemUI();
...
public:
	...
	void PaintBkImage( GRAPHorHDC& gorh );
